    ...
    <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center gap-6 px-4 py-12 sm:px-6">
      ...
      <form action={formAction} className="flex flex-col gap-4">
        ...
        <TextField
          ...
          required
        />
        <label className="flex items-start gap-2 py-1 text-sm text-zinc-600 dark:text-zinc-400">
          <input name="acceptedTerms" type="checkbox" required className="mt-0.5 h-5 w-5 shrink-0" />
